...
////                        if(isset($_POST['gh_id']) && isset($_POST['user_id']))
////	{
////                        $_SESSION['id_them_vao_gio']=trim($_POST['gh_id']);
                                            ...
                                            <div class="fieldset">
                                                <div class="field  field--show-floating-label" data-bind-class="{&#39;field--show-floating-label&#39;: email}">
                                                    <div class="field__input-wrapper">
                                                        ...
                                                        <input name="email" id="email" type="email" class="field__input"  value="<?php // echo $email;?>">
                                                    </div>
                                                ...
                                                <div class="field  field--show-floating-label" data-bind-class="{&#39;field--show-floating-label&#39;: billing.name}">
                                                    <div class="field__input-wrapper">
                                                        ...
                                                        <input name="billingName" id="billingName" type="text" class="field__input" data-bind="billing.name" value="<?php //echo $ten_nguoi_mua;?>">
                                                    </div>
                                                ...
                                                <div class="field " data-bind-class="{&#39;field--show-floating-label&#39;: billing.phone}">
                                                    <div class="field__input-wrapper">
                                                        ...
                                                        <input name="billingPhone" id="billingPhone" type="tel" class="field__input" data-bind="billing.phone" value="<?php //echo $dien_thoai;?>">
                                                    </div>
                                                ...
                                                <div class="field " data-bind-class="{&#39;field--show-floating-label&#39;: billing.address}">
                                                    <div class="field__input-wrapper">
                                                        ...
                                                        <input name="billingAddress" id="billingAddress" type="text" class="field__input" data-bind="billing.address" value="<?php //echo $dia_chi;?>">
                                                    </div>
